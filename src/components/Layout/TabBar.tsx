...
export const TAB_COLORS = [
  ...
  { key: 'red', label: 'Red', value: '#b91c1c' },
  { key: 'rose', label: 'Rose', value: '#be123c' },
  { key: 'orange', label: 'Orange', value: '#c2410c' },
  { key: 'amber', label: 'Amber', value: '#b45309' },
  { key: 'yellow', label: 'Yellow', value: '#a16207' },
  { key: 'lime', label: 'Lime', value: '#4d7c0f' },
  { key: 'green', label: 'Green', value: '#15803d' },
  { key: 'emerald', label: 'Emerald', value: '#047857' },
  { key: 'teal', label: 'Teal', value: '#0f766e' },
  { key: 'cyan', label: 'Cyan', value: '#0e7490' },
  { key: 'sky', label: 'Sky', value: '#0369a1' },
  { key: 'blue', label: 'Blue', value: '#1d4ed8' },
  { key: 'indigo', label: 'Indigo', value: '#4338ca' },
  { key: 'violet', label: 'Violet', value: '#6d28d9' },
  { key: 'purple', label: 'Purple', value: '#7e22ce' },
  { key: 'fuchsia', label: 'Fuchsia', value: '#a21caf' },
  { key: 'pink', label: 'Pink', value: '#be185d' },
  { key: 'crimson', label: 'Crimson', value: '#9f1239' },
  { key: 'brown', label: 'Brown', value: '#78350f' },
  { key: 'slate', label: 'Slate', value: '#334155' },
  { key: 'charcoal', label: 'Charcoal', value: '#1e293b' },
  { key: 'wine', label: 'Wine', value: '#831843' },
]
