  ...
  return (
    <>
      <div
        ...
        style={cardBgStyle}
        className={`group relative glass-card rounded-xl sm:rounded-2xl p-2 sm:p-4 flex flex-col h-[160px] sm:h-[200px] cursor-pointer transition-all duration-200 hover:scale-[1.02] overflow-hidden ${
      ...
      >
        ...
        {/* Footer: type badge + expiration + date — pinned to bottom */}
      ...
      {notes.length === 0 ? (
        <div className="flex-1 flex items-center justify-center min-h-full animate-[fadeIn_0.2s_ease-out]">
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500">Create a note to get started</p>
          </div>
        </div>
      ) : (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-1 sm:gap-2 rounded-xl sm:rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600 text-gray-400 dark:text-gray-500 hover:border-[var(--accent)] hover:text-[var(--accent)] transition-all duration-200 hover:scale-[1.02] h-[160px] sm:h-[200px]"
          >
